...
_BUTTONCOMMANDREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='state', full_name='ButtonCommandRequest.state', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BUTTONSTATERESPONSE = _descriptor.Descriptor(
  name='ButtonStateResponse',
  full_name='ButtonStateResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='ButtonStateResponse.key', index=0,
      number=1, type=7, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='state', full_name='ButtonStateResponse.state', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['ButtonStateResponse'] = _BUTTONSTATERESPONSE
...
ButtonStateResponse = _reflection.GeneratedProtocolMessageType('ButtonStateResponse', (_message.Message,), {
  'DESCRIPTOR' : _BUTTONSTATERESPONSE,
  '__module__' : 'api_pb2'
  # @@protoc_insertion_point(class_scope:ButtonStateResponse)
  })
_sym_db.RegisterMessage(ButtonStateResponse)
...
_BUTTONSTATERESPONSE._options = None
